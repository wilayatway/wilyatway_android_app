...
class AsmaUlNabiScreen extends StatefulWidget {
  const AsmaUlNabiScreen({super.key});

  @override
  _AsmaUlNabiScreenState createState() => _AsmaUlNabiScreenState();
}

class _AsmaUlNabiScreenState extends State<AsmaUlNabiScreen> {
                        ...
                        child: Card(
                          ...
                          child: Theme(
                            ...
                            child: ExpansionTile(
                              ...
                              collapsedIconColor: const Color.fromARGB(
                                179,
                                255,
                                0,
                                0,
